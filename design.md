...
| Data Model | Purpose |
|---|---|
| [Physical Topology - Campus Network](models/physical%topology.yaml) | Ground-truth inventory of campus network hardware and cabling — devices, ports, and interconnects. |
